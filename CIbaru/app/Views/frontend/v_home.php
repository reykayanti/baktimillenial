...
<div class="row pt-2">
    ...
    <div class="col-6 pt-0 py-5 p-lg-5 ">
        <div class="flex">
            ...
            <p class="">Dibiayai penuh oleh Yayasan Anak Millenial Indonesia</p>
        </div>
        <div class="">
            <div class="d-flex">
                <i class="material-icons">&#xe314;</i>
            ...
            <p class="px-7">Diberikan potongan biaya jalur beasiswa.</p>
        </div>
        <div class="">
            <div class="d-flex">
                <i class="material-icons">&#xe314;</i>
            ...
            <p class="">Keseluruhan biaya ditanggung pribadi.</p>
        </div>
    </div>
</div>
...
<div class="container-fluid py-5 p-lg-5" style="background: #FAD586">
    <div class="row">
        <div class="d-flex justify-content-center align-items-center flex-column col-7">
            <h1>Lokasi</h1>
            <p class="text-justify">Bakti Milenial merupakan sebuah program dibawah naungan Indonesia Milenial Connect
                (IMC).
                Indonesia Milenial Connect merupakan wadah pengembangan diri bagi pemuda/i Indonesia baik yang
                berada dalam negeri maupun luar negeri, berfokus kepada tiga bidang yang menjadi faktor
                kesejahteraan pemberdayaan masyarakat yaitu, pendidikan, sosial, dan ekonomi.
...
<div class="container">
    ...
    <div class="button-about-info">
        <a href="#" class="rounded btn-warning d-flex"> Selengkapnya</a>
    </div>
</div>
</div>

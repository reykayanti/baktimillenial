...
<form action="/Cdetailartikel/detail/<?= isset($blog['id_program']); ?>" method="POST">


    <div class="container text-justify py-5">
        <h1 class="title" name="judul" id="judul" value="<?= isset($blog['judul']); ?>"></h1>
        ...
        <p style="text-indent: 5rem;margin-top: 50px;font-size: 14px;">
